...
ax.set_title('Nuovi Record di Temperatura Minima Più Alta in Europa (1940-2026) [Primi 15 anni usati come storico]', fontsize=18)
...
output_path = 'docs/record_heatmap_yearly_min_europe.png'
