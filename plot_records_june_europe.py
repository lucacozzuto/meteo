...
display_cities = [c for c in heatmap_data.index]
...
ax.set_title('Nuovi Record di Temperatura Massima ASSOLUTA a GIUGNO nelle Capitali Europee (1940-2026) [Primi 15 anni usati come storico]', fontsize=18)
...
output_path1 = os.path.join(artifact_dir, 'record_heatmap_june_europe.png')
output_path2 = '/Users/lcozzuto/git/meteo/record_heatmap_june_europe.png'
