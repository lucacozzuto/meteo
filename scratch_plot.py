...
def plot_waves(cities, output_file):
    ...
    plt.title("Ondate di Calore in Estate (Giugno-Luglio-Agosto, 1975-2026)", color='white', fontsize=20, pad=20)
    plt.tight_layout()
    plt.savefig(output_file, dpi=200, facecolor='#1a1a2e')
    plt.close()

if __name__ == "__main__":
    # Get 15 random cities from Italy to test
    cities = sorted(glob.glob('data_italy/*.csv'))[:15]
    out_path = '/Users/lcozzuto/.gemini/antigravity/brain/e9a954cd-73d4-4826-91e2-4e6263f6d002/scratch/heatwave_waves.png'
    plot_waves(cities, out_path)
