...
ax.set_title('Nuovi Record di Precipitazione Giornaliera in Europa (1940-2026) [Primi 15 anni usati come storico]', fontsize=18)
...
output_path = '/Users/lcozzuto/git/meteo/docs/record_heatmap_rain_europe.png'
